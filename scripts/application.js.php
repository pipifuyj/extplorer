 ...
 * @license
 * @version $Id: application.js.php 150 2009-06-27 20:10:10Z soeren $
...
/*    	<?php if( ($GLOBALS["zip"] || $GLOBALS["tar"] || $GLOBALS["tgz"]) && !ext_isFTPMode() ) { ?>
	...
	var tree =  {
            ...
            region: "west",
        	id: "mytree",
        	title: '<?php echo ext_Lang::msg('directory_tree', true ) ?> <img src="<?php echo _EXT_URL ?>/images/_reload.png" hspace="20" style="cursor:pointer;" title="reload" onclick="Ext.getCmp(\'mytree\').getRootNode().reload();" alt="Reload" align="middle" />', 
        	closable: false,
            initialSize: 200,
            minSize: 175,
            maxSize: 400,
